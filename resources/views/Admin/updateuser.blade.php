    ...
    <div class="mt-8">
        ...
        <form action="/dashboardadmin/update/{{ $user->id }}" method="post">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="fullname" id="fullname" value="{{ $user->fullname }}" class="mt-1 p-2 w-full border rounded">
            </div>

            <div class="mb-4">
                <label for="kelas" class="block text-gray-600 text-sm font-medium">Kelas</label>
                <input type="text" name="kelas" id="kelas" value="{{ $user->kelas }}" placeholder="SI-XX-XX" class="mt-1 p-2 w-full border rounded">
            </div>
